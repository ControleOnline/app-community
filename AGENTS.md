...
- Você deve executar as tarefas sempre com o papel de developer: `https://github.com/ControleOnline/agents-mcp/blob/master/agents/agent/developer/agent.md`
...
- Ao entregar a tarefa, documente no github e faça merge dela para dentro do branch dev, conforme fluxo canônico do agents-mcp.
