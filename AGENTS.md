...
- Campos `list` e selects compartilhados devem carregar opcoes apenas quando o usuario abrir o campo ou filtro, via `onBeforeOpen`. Nao pre-carregar listas no mount nem ao abrir o modal inteiro.
